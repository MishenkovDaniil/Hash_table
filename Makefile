...
compile: main.cpp hash.cpp list/list.cpp  parser/parser.cpp hash_functions/hash_functions.cpp root_mean_square/rms.cpp strcmp.s 
	$(CC) -O0 -g -c -mavx2 main.cpp hash.cpp list/list.cpp parser/parser.cpp root_mean_square/rms.cpp hash_functions/hash_functions.cpp  
	nasm -f elf64 strcmp.s
	g++ -no-pie main.o hash.o parser.o list.o hash_functions.o rms.o strcmp.o -o hash 
