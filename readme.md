...
Следующие оптимизации также ускорили работу всей программы на несколько процентов, что привело к общему ускорению практически в 4 раза. Полученные данные сходятся с данными из программы `valgrind`.
...
которые практически не отличаются от полученных нами, но все же на несколько процентов быстрее.
