...
|:--------------------------------------:|:----------------:|:---------------------------------------:|:----------------------------------------:|
| Начальная                              | 650.0 ± 3.3    678.6 +- 3.4  | 1                                       |1                                         |
| С оптимизированной хэш-функцией        | 351.9 ± 3.2   360.1 +- 2.1   | 1.85                                    |1.85->1.88                                      |
| С оптимизированной функцией `strcmp`   | 273.5 ± 2.9   292.4 +- 3.3   | 2.38                                    |1.29->1.23                                      |
| С оптимизированной функцией поиска     | 268.8 ± 2.1      | 2.42                                    |1.02->1.09                                      |
